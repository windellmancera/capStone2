...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        if ($insert_stmt->execute()) {
            ...
            $message .= "<div style='background: rgba(255,255,255,0.1); padding: 10px; border-radius: 5px; margin: 10px 0;'>";
            $message .= "<a href='$reset_link' style='color: #4CAF50; text-decoration: underline; word-break: break-all;'>$reset_link</a>";
            $message .= "</div><br>";
