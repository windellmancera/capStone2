...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        // Check if user is a member (role = 'member' for regular members)
        if ($user['role'] !== 'member') {
            $error = "This account is not a member account. Please use the correct login page.";
...
<head>
    <meta charset="UTF-8">
    <title>Member Login - Almo Fitness Gym</title>
    <style>
        * {
