...
// Active members (those who are not expired)
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <a href="manage_members.php" class="block">
                    <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl shadow-lg p-6 text-white transform hover:scale-105 transition-all duration-300 cursor-pointer">
                ...
                <a href="manage_members.php?status=active" class="block">
                    <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-xl shadow-lg p-6 text-white transform hover:scale-105 transition-all duration-300 cursor-pointer">
                        <div class="flex items-center justify-between">
                            <div>
                ...
                <a href="attendance_history.php" class="block">
                    <div class="bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-xl shadow-lg p-6 text-white transform hover:scale-105 transition-all duration-300 cursor-pointer">
                        <div class="flex items-center justify-between">
                            <div>
                ...
                <a href="manage_payments.php" class="block">
                    <div class="bg-gradient-to-br from-red-500 to-red-600 rounded-xl shadow-lg p-6 text-white transform hover:scale-105 transition-all duration-300 cursor-pointer">
                        <div class="flex items-center justify-between">
                            <div>
        ...
        <div class="mt-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-6xl mx-auto">
                ...
                <div class="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-lg border border-yellow-200 p-4 hover:shadow-md transition-all duration-300 h-32">
                    ...
                    <div class="text-lg font-bold text-gray-900 mb-1"><?php echo htmlspecialchars($topPlan['plan_name']); ?></div>
                    <p class="text-xs text-gray-600"><?php echo number_format($topPlan['active_subscribers']); ?> subscribers</p>
                </div>
                ...
                <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg border border-blue-200 p-4 hover:shadow-md transition-all duration-300 h-32">
                    ...
                    <div class="text-lg font-bold text-gray-900 mb-1">
                        <?php $hour = $peakHours['hour']; echo date('g:i A', strtotime("$hour:00")); ?>
                    </div>
                ...
                <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg border border-purple-200 p-4 hover:shadow-md transition-all duration-300 h-32">
                    ...
                    <div class="text-lg font-bold text-gray-900 mb-1"><?php echo htmlspecialchars($topTrainer['trainer_name']); ?></div>
                    <p class="text-xs text-gray-600"><?php echo $topTrainer['average_rating']; ?>/5 (<?php echo $topTrainer['total_ratings']; ?> reviews)</p>
                </div>
                ...
                <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-lg border border-green-200 p-4 hover:shadow-md transition-all duration-300 h-32">
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <?php $growth = $memberGrowth['last_month'] > 0 ? round(($memberGrowth['this_month'] - $memberGrowth['last_month']) / $memberGrowth['last_month'] * 100, 1) : 100; ?>
