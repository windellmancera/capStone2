...
echo "<h2>Testing Final Active Members Count</h2>";

// Test the updated query that only checks for approved/pending payments
$active_query = "
...
echo "<h3>Active Members Count (Approved + Pending, no end date restriction): $active_count</h3>";
...
while ($member = $detailed_result->fetch_assoc()) {
    ...
    // Count as active if they have approved OR pending payment (no end date restriction)
